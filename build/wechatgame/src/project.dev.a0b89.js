require = function() {
  ...
  GameStatus: [ function(require, module, exports) {
    ...
    var GAME_PAUSED = "GamePaused";
    var GAME_RESUME = "GameResume";
    var GAME_RESTART = "GameRestart";
    var SCORE_CHANGED = "ScoreChanged";
    var STAR_DISAPPEARING = "StarDisappearing";
    var PROGRESSBAR_FOLLOWSTAR = "ProgressBarFollowStar";
    cc._RF.pop();
  }, {} ],
